...
% Last Modified by GUIDE v2.5 20-Mar-2020 00:08:31
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
[filename1 pathname1]=uigetfile({'*.mp4';'*.avi';'*.mp3'},'select video')
fullpathname1=[pathname1,filename1];
x=VideoReader(fullpathname1);
y=implay(x);    
...
% handles    structure with handles and user data (see GUIDATA)
vid1
msg='hiding is done successfully ';
set(handles.edit2,'string',msg)
if isequal('video.avi',0) | isequal('C:\Users\User\Documents\MATLAB\New folder\video.avi',0)
     msg='hiding is not done successfully';
        set(handles.edit2,'string',msg)
